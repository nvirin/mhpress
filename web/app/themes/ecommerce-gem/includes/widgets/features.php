					...
					<?php if( !empty( $icon_one ) || !empty( $feature_one ) || !empty( $text_one ) ){ ?>
						<div class="feature-item feature-item-one">
							<div class="feature-inner">
								...
								<?php 
								if( !empty( $feature_one ) || !empty( $text_one ) ){ ?>
									<div class="feature-text-wrap">
									    <?php 
									    if( !empty( $feature_one ) ){ ?>
									    	<h2 class="feature-title"><?php echo esc_html( $feature_one ); ?></h2>
									    	<?php 
									    } ?>
					...
					<?php if( !empty( $icon_two ) || !empty( $feature_two ) || !empty( $text_two ) ){ ?>
						<div class="feature-item feature-item-two">
							<div class="feature-inner">
								...
								<?php 
								if( !empty( $feature_two ) || !empty( $text_two ) ){ ?>
									<div class="feature-text-wrap">
									    <?php 
									    if( !empty( $feature_two ) ){ ?>
									    	<h2 class="feature-title"><?php echo esc_html( $feature_two ); ?></h2>
									    	<?php 
									    } ?>
					...
					<?php if( !empty( $icon_three ) || !empty( $feature_three ) || !empty( $text_three ) ){ ?>
						<div class="feature-item feature-item-three">
							<div class="feature-inner">
								...
								<?php 
								if( !empty( $feature_three ) || !empty( $text_three ) ){ ?>
									<div class="feature-text-wrap">
									    <?php 
									    if( !empty( $feature_three ) ){ ?>
									    	<h2 class="feature-title"><?php echo esc_html( $feature_three ); ?></h2>
									    	<?php 
									    } ?>
		...
		function form( $instance ) {
	        ...
	        <p>
		        <small>
		        	...
		        	<?php printf( esc_html__( '%1$s %2$s', 'ecommerce-gem' ), 'ET-LINE icons are used for icon of each blocks. You can find icon code', '<a href="http://rhythm.nikadevs.com/content/icons-et-line" target="_blank">here</a>' ); ?>
		        </small>
	        </p>
