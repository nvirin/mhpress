	...
	class eCommerce_Gem_About {
		...
		public function load_assets( $hook ) {
			...
			if ( 'appearance_page_' . $this->page_slug === $hook ) {
				...
				wp_enqueue_style( 'ecommerce-gem-about', get_template_directory_uri() . '/includes/theme-info/css/about.css', array(), '1.0.0' );
				wp_enqueue_script( 'ecommerce-gem-about', get_template_directory_uri() . '/includes/theme-info/js/about.js', array( 'jquery' ), '1.0.0' );
				$js_vars = array(
		...
		public function free_pro() {
		    ...
		    if ( ! empty( $free_pro ) ) {
		        ...
		        if ( ! empty( $free_pro ) && is_array( $free_pro ) ) {
		            ...
		            echo '<td></td>';
		            echo '<td colspan="2"><a href="https://promenadethemes.com/downloads/ecommerce-gem-plus/" target="_blank" class="button button-primary button-hero">eCommerce Gem Plus</a></td>';
		            echo '</tr>';
