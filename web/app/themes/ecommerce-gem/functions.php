...
function ecommerce_gem_setup() {
	 ...
	 */
	load_theme_textdomain( 'ecommerce-gem' );
...
function ecommerce_gem_scripts() {
	...
	wp_enqueue_script( 'ecommerce-gem-custom', get_template_directory_uri() . '/assets/js/custom.js', array( 'jquery' ), '1.0.3', true );
...
function ecommerce_gem_admin_scripts( $hook ) {
	...
	if( 'widgets.php' === $hook ){
		...
		wp_enqueue_style( 'ecommerce-gem-admin', get_template_directory_uri() . '/includes/widgets/css/admin.css', array(), '1.0.3' );

		wp_enqueue_media();

		wp_enqueue_script( 'ecommerce-gem-admin', get_template_directory_uri() . '/includes/widgets/js/admin.js', array( 'jquery' ), '1.0.3' );
